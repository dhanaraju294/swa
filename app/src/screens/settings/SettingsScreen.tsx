    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Card style={styles.card}>
        ...
        <Text style={styles.rowDesc}>
          {settings?.reminder_time || 'No reminder set'}
        </Text>
        <Button
          title={settings?.reminder_time ? 'Clear Reminder' : 'Set Reminder (9:00 AM)'}
          onPress={() =>
            updateSettings({
              theme: settings?.theme || 'default',
              reminder_time: settings?.reminder_time ? null : '09:00',
              export_format_pref: settings?.export_format_pref || 'json',
            })
          }
          variant="secondary"
          color={colors.gold}
