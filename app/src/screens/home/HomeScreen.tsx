      ...
      <Card style={styles.streakCard}>
        <View style={styles.streakRow}>
          ...
          <View style={styles.streakMeta}>
            ...
            <Text style={styles.streakMetaValue}>{streak?.longest_streak || 0}</Text>
          </View>
        </View>
      </Card>
          ...
          <View style={styles.journeyCardInner}>
            ...
            <View style={styles.journeyInfo}>
              ...
              <Text style={styles.journeySub}>
                Day {sevenDayProgress?.current_day || 1} of 7
              </Text>
              <ProgressPetals
                total={7}
                current={sevenDayProgress?.current_day || 1}
                completed={sevenDayProgress?.completed_days || []}
              />
            </View>
          </View>
        </Card>
        ...
        <Card style={styles.journeyCard}>
          <View style={styles.journeyCardInner}>
            ...
            <View style={styles.journeyInfo}>
              ...
              <Text style={styles.journeySub}>
                Day {twentyOneDayProgress?.current_day || 1} of 21
              </Text>
              <ProgressPetals
                total={21}
                current={twentyOneDayProgress?.current_day || 1}
                completed={twentyOneDayProgress?.completed_days || []}
              />
            </View>
          </View>
        </Card>
