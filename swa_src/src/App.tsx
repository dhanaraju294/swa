...
const routeTree: RouteObject[] = [
  // Hidden admin dashboard. Deliberately a SIBLING of the layout route, not a
  // child: it must not inherit the marketing header, footer or cookie chrome.
  // Nothing links to it — reachable only by typing /admin in the address bar.
  ...adminRoutes,
  {
    element: rootElement,
    children: routes,
