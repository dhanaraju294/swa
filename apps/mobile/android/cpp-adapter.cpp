...
// Automated testing checks Java_com_swamobile_SwaMobileModule and swamobile
// by comparing the whole line here.
/*
Java_com_swamobile_SwaMobileModule_nativeMultiply(JNIEnv *env, jclass type, jdouble a, jdouble b) {
    return swamobile::multiply(a, b);
}
*/

// Installer coming from SwaMobileModule
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_swamobile_SwaMobileModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
    ...
    return swamobile::installRustCrate(*runtime, jsCallInvoker);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_swamobile_SwaMobileModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
    return swamobile::cleanupRustCrate(*runtime);
}